...
public class CardioGraph extends AppCompatActivity implements Bluetooth.CommunicationCallback {
    ...
    private void calcDanger(int bpm) {
        ...
        if (dBpm < min) {
            AlertDialog.Builder dialog = new AlertDialog.Builder(CardioGraph.this);
            dialog.setTitle("Warning");
            dialog.setMessage("Your heart rate is below normal");
            ...
            AlertDialog.Builder dialog = new AlertDialog.Builder(CardioGraph.this);
            dialog.setTitle("Warning");
            dialog.setMessage("Your heart rate is above normal");
            dialog.setIcon(R.mipmap.heart);
            dialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    String tel = "tel:119";
